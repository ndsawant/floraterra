...
require_once WPSEO_PATH.'plugin-updates/plugin-update-checker.php';
$MyUpdateChecker = new PluginUpdateChecker(
    'http://genesis.mywsiportal.com/genesis-updates/wsi-genesis-seo/metadata.json',
    __FILE__,
    'wsi-genesis-seo'
);