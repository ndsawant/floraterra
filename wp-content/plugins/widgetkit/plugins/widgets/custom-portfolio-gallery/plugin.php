...
return array(
    ...
    'name' => 'widget/custom-portfolio-gallery',

    'main' => 'YOOtheme\\Widgetkit\\Widget\\Widget',

    'config' => array(

        'name'  => 'custom-portfolio-gallery',
        'label' => 'Custom Portfolio Gallery',
        'core'  => false,
        'icon'  => 'plugins/widgets/custom-portfolio-gallery/widget.svg',
        'view'  => 'plugins/widgets/custom-portfolio-gallery/views/widget.php',
    ...
    'events' => array(
        ...
        'init.admin' => function($event, $app) {
            $app['angular']->addTemplate('custom-portfolio-gallery.edit', 'plugins/widgets/custom-portfolio-gallery/views/edit.php', true);
        }
