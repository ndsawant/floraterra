...
<div id="filters" class="wk-tab-center button-group">  
    <button class="button is-checked" data-filter="*">All</button>
    <?php foreach ($tags as $i => $tag) : ?>
    <button class="button" data-filter=".<?php echo $tag; ?>"><?php echo ucwords($tag); ?></button>
<?php endforeach; ?> 
</div>
<div id="wk-grid<?php echo $settings['id']; ?>" class="isotope {wk}-gallery <?php echo $grid; ?> <?php echo $settings['class']; ?>" <?php echo $grid_js; ?> <?php echo $animation; ?>>
...
<?php foreach ($items as $index => $item) : ?>
    <?php if ($item['media']) :
        ...
        $lightbox_caption = $lightbox_caption ? 'title="' . $lightbox_caption .'"' : '';
    ...
    <div<?php //echo $filter; ?> class="element-item <?php echo implode(' ', $item['tags']); ?>" data-category="<?php echo array_values($item['tags'])[0]; //implode(',', $item['tags']); ?>">
...
<style>
.wk-dynamic-gallery .wk-portfolio-gallery { padding: 0; }
</style>
<script src="/wp-content/plugins/widgetkit/plugins/widgets/custom-portfolio-gallery/assets/js/isotope.pkgd.js"></script>
<script src="/wp-content/plugins/widgetkit/plugins/widgets/custom-portfolio-gallery/assets/js/isotope-load-more.js"></script>
<link rel="stylesheet" type='text/css' href="/wp-content/plugins/widgetkit/plugins/widgets/custom-portfolio-gallery/assets/css/isotope-style.css"/>