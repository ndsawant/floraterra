        ...
        <div<?= get_attrs($attrs_page) ?>>
            ...
            <div id="tm-main" class="tm-main uk-section uk-section-default" uk-height-viewport="expand: true">
                <div class="uk-container">
					...
					<?php if ( is_page_template( 'page-without-sidebar.php' ) ) :?>
                        <div class="uk-width-1-1@<?= $theme->get('sidebar.breakpoint') ?>">
					<?php else: ?>
                        <div class="uk-width-2-3@<?= $theme->get('sidebar.breakpoint') ?>">
					<?php endif ?>
